  ...
  return (
    <div className='w-screen overflow-x-scroll text-red-500'>
      ...
      <div className='w-max flex'>
        ...
        <div key={item.id} className='w-screen h-[60vh] flex flex-col items-center justify-around p-4 bg-fuchsia-50 transition-all duration-300 md:w-[50vw] xl:w-[33vw] xl:h-[90vh]'>
          {/* IMAGE CONTAINER */}
